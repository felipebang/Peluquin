...
@Data
@NoArgsConstructor
@Table(name = Constantes.TABLE_HISTORIA_GANANCIAS, schema = Constantes.SCHEMA_DB_IF)
public class HistoriaGanancias implements Serializable  {
	...
	@Column(name = "id_historia_ganancias")
	private Long  idHistoriaGanancias;
