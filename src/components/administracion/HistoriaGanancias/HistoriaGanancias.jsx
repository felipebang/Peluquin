...
const HistoriaGanancias = props => {
	...
	//api
	const gananciasApi = {
		buscar: '/historiaganancias/buscar'
	};
	...
	return (
		<div className='flex-row'>
			<div className='col-12'>
				<ToolBar breadcrumbs={HISTORIAGANANCIAS_BREADCRUMBS} buttons={toolbarButtons} />
...
export default withRouter(HistoriaGanancias);
